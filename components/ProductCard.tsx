  ...
  return (
    ...
    >
      ...
      <Link to="/product/$productId" params={{ productId: product.id } as any} className="flex-1 flex flex-col">
        <div className="aspect-square relative overflow-hidden bg-[#030303] flex items-center justify-center p-4 sm:p-6 md:p-8">
          <img
            src={product.image}
            alt={product.name}
          ...
          <div className="absolute inset-0 bg-black/70 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center p-4 sm:p-6 md:p-8">
            <button
              onClick={(e) => { e.preventDefault(); e.stopPropagation(); onQuickView(product); }}
              className="w-full py-2.5 sm:py-3 md:py-3.5 bg-white text-black text-[10px] font-black uppercase tracking-[0.4em] rounded-xl transform translate-y-0 md:translate-y-8 md:group-hover:translate-y-0 transition-all duration-500 shadow-2xl flex items-center justify-center gap-3"
            >
        ...
        <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between space-y-3 sm:space-y-4">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <button
              ...
              className="w-full py-2.5 sm:py-3 md:py-3.5 border-2 border-white/[0.02] hover:border-[#CDA032] group-hover:bg-[#CDA032]/5 rounded-xl text-[10px] font-black uppercase tracking-[0.3em] transition-all flex items-center justify-center gap-3"
            >
